...
file and subscribes to messages on a subject.
"""
...
CREDS_FILE = Path(__file__).parent / "creds" / "notification.creds"
...
async def main() -> None:
    """
    Connect to the NATS server using JWT authentication and
